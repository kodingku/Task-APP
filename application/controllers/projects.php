...
class Projects extends CI_Controller
{
	...
	public function __construct() {
		...
		$this->session->set_flashdata('no_access','sory you are not allowed or you not login');
	...
	public function create(){
		...
		$this->form_validation->set_rules('project_body','Description Project','trim|required');
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($this->project_model->create_project($data)) {
				...
				$this->session->set_flashdata('project_created','you project success has been created');
	...
	public function edit($project_id) {
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($this->project_model->edit_project($project_id, $data)) {
				...
				$this->session->set_flashdata('project_update','you project success has been update');
				redirect("projects/index");
	...
	public function delete($project_id){
		...
		$this->session->set_flashdata('project_deleted','you project success has been deleted');
		redirect("projects/index");
	}
